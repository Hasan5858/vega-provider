...
function fastdlExtractor(link, signal) {
    return __awaiter(this, void 0, void 0, function () {
        var response, finalUrl, html, linkMatch, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!(!finalUrl || finalUrl === link)) return [3 /*break*/, 3];
                    return [4 /*yield*/, response.text()];
                case 2:
                    html = _a.sent();
                    linkMatch = html.match(/href=["']([^"']*(?:drive\.google\.com|cdnjs|cdn)[^"']*)["']/);
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error('[FastDL Extractor Error]', error_1 instanceof Error ? error_1.message : error_1);
                    return [2 /*return*/, []];
