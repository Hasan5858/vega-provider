        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getBaseUrl("Topmovies")];
                case 1:
                    baseUrl = _c.sent();
                    url = "".concat(baseUrl + filter, "/page/").concat(page, "/");
                    return [2 /*return*/, posts(url, signal, providerContext)];
            }
        });
    });
};
...
function posts(url, signal, providerContext) {
    return __awaiter(this, void 0, void 0, function () {
        var axios, cheerio, res, data, $_1, catalog_1, err_1;
