...
var getMeta = function (_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var axios, cheerio, url, res, data, $_1, meta, links_1, err_1;
        var _c;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    meta = {
                        title: $_1(".imdbwp__title").text(),
                        synopsis: $_1(".imdbwp__teaser").text(),
                        image: $_1(".imdbwp__thumb").find("img").attr("src") || "",
                        imdbId: ((_c = $_1(".imdbwp__link").attr("href")) === null || _c === void 0 ? void 0 : _c.split("/")[4]) || "",
                        type: $_1(".thecontent").text().toLocaleLowerCase().includes("season")
                            ? "series"
                            : "movie",
                    };
                    links_1 = [];
                    ...
                    return [2 /*return*/, __assign(__assign({}, meta), { linkList: links_1 })];
                case 2:
                    err_1 = _d.sent();
                    console.error(err_1);
                    return [2 /*return*/, {
