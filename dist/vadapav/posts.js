        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getBaseUrl("vadapav")];
                case 1:
                    baseUrl = _c.sent();
                    if (page > 1) {
                        return [2 /*return*/, []];
                    }
                    url = "".concat(baseUrl + filter);
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    url = "".concat(baseUrl, "/s/").concat(searchQuery);
                    return [2 /*return*/, posts({ baseUrl: baseUrl, url: url, signal: signal, axios: axios, cheerio: cheerio })];
            }
        });
    });
...
function posts(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        var 
        // baseUrl,
        url = _b.url, signal = _b.signal, axios = _b.axios, cheerio = _b.cheerio;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                ...
                case 1:
                    ...
                    catalog_1 = [];
                    $_1('.directory-entry:not(:contains("Parent Directory"))').map(function (i, element) {
                        var _a;
                        var title = $_1(element).text();
                        var link = $_1(element).attr("href");
                        var imageTitle = (title === null || title === void 0 ? void 0 : title.length) > 30
                        ...
                        var image = "https://placehold.jp/23/000000/ffffff/200x400.png?text=".concat(encodeURIComponent(imageTitle), "&css=%7B%22background%22%3A%22%20-webkit-gradient(linear%2C%20left%20bottom%2C%20left%20top%2C%20from(%233f3b3b)%2C%20to(%23000000))%22%2C%22text-transform%22%3A%22%20capitalize%22%7D");
                        if (title && link) {
                            catalog_1.push({
                                title: title,
                                link: link,
