...
var getMeta = function (_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var axios, cheerio, baseUrl_1, url, res, data, $_1, title, links_1, directLinks_1, err_1;
        var _c, _d;
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    baseUrl_1 = link === null || link === void 0 ? void 0 : link.split("/").slice(0, 3).join("/");
                    url = link;
                ...
                case 1:
                    ...
                    title = ((_d = (_c = $_1(".directory")
                        .children()
                        .first()
                        .text()
                        .trim()) === null || _c === void 0 ? void 0 : _c.split("/").pop()) === null || _d === void 0 ? void 0 : _d.trim()) || "";
                    links_1 = [];
                    $_1('.directory-entry:not(:contains("Parent Directory"))').map(function (i, element) {
                        var link = $_1(element).attr("href");
                        if (link) {
                            links_1.push({
                                episodesLink: baseUrl_1 + link,
                                title: $_1(element).text(),
                            });
                        }
                    });
                    directLinks_1 = [];
