...
exports.luluvdooExtractor = luluvdooExtractor;
 ...
 */
function luluvdooExtractor(url, axios, signal) {
    return __awaiter(this, void 0, void 0, function () {
        var response, html, sourcesMatch, hlsUrl, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    sourcesMatch = html.match(/sources:\s*\[\s*\{\s*file:\s*["']([^"']+)["']/i);
                    if (!sourcesMatch) {
                        console.error("LuluVDoo: Could not find sources in page");
                        return [2 /*return*/, null];
                    }
                    hlsUrl = sourcesMatch[1];
                ...
                case 2:
                    ...
                    console.error("LuluVDoo: Extraction error:", error_1.message);
                    return [2 /*return*/, null];
