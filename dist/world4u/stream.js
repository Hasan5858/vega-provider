    ...
    return __awaiter(this, arguments, void 0, function* ({ link: url, type, providerContext, }) {
        ...
        try {
            ...
            if (url.includes("w4links.skin")) {
                ...
                const w4linksRes = yield axios.get(url, { headers });
            ...
            if (url.includes("photolinx")) {
                ...
                // const photolinxBaseUrl = url.split('/').slice(0, 3).join('/');
                const photolinxRes = yield fetch(url, {
                    headers: {
            ...
            try {
                ...
                console.log("error in world4uGetStream key extraction", err instanceof Error ? err.message : err);
            ...
            if (mediafireUrl) {
                ...
                if (urlContentType && urlContentType.includes("video")) {
                    ...
                    let downloadLInk = (href === null || href === void 0 ? void 0 : href.startsWith("https://")) ? href : null;
            ...
            if (contentType && contentType.includes("video")) {
                ...
                const repairRequireRepairRes = yield fetch("https://www.mediafire.com" + repairLink);
