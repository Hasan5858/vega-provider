        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getBaseUrl("w4u")];
                case 1:
                    baseUrl = _c.sent();
                    url = "".concat(baseUrl + filter, "/page/").concat(page, "/");
                    return [2 /*return*/, posts({ url: url, signal: signal, axios: axios, cheerio: cheerio })];
            }
        });
    });
};
...
function posts(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        var url = _b.url, signal = _b.signal, axios = _b.axios, cheerio = _b.cheerio;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                ...
                case 1:
                    ...
                    $_1(".recent-posts")
                        ...
                        var title = $_1(element).find(".post-thumb").find("a").attr("title");
                        var link = $_1(element).find(".post-thumb").find("a").attr("href");
                        var image = $_1(element).find(".post-thumb").find("img").attr("data-src") ||
                            $_1(element).find(".post-thumb").find("img").attr("src");
                        if (title && link && image) {
                            catalog_1.push({
