        ...
        try {
            ...
            for (const match of buttonMatches) {
                ...
                try {
                    ...
                    // Method 1: Regex extraction (finds different URLs than cheerio)
            ...
            const uniqueStreams = streamLinks.filter((stream, index, self) => index === self.findIndex(s => s.link === stream.link));
