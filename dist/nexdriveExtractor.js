...
function nexdriveExtractor(link, signal) {
    return __awaiter(this, void 0, void 0, function () {
        var res, html, $_1, streams_1, seenLinks_1, links, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    console.log('[NexDrive] Extracting from:', link);
                    return [4 /*yield*/, axios_1.default.get(link, { headers: headers_1.headers, signal: signal, timeout: 15000 })];
                case 1:
                    res = _a.sent();
                    html = res.data;
                    ...
                    streams_1 = [];
                    seenLinks_1 = new Set();
                    links = $_1('a[href*="fastdl"], a[href*="vcloud"], a[href*="filebee"], a[href*="gdtot"], a[href*="dropgalaxy"], a[href*="dgdrive"]');
                    ...
                    links.each(function (_, element) {
                        ...
                        console.log("[NexDrive] Added ".concat(extractorName, ": ").concat(server));
                    });
                    console.log('[NexDrive] Extracted', streams_1.length, 'streams');
                    return [2 /*return*/, streams_1];
                case 2:
                    error_1 = _a.sent();
                    console.error('[NexDrive] Error:', error_1.message);
                    return [2 /*return*/, []];
