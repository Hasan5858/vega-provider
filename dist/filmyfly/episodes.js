...
var getEpisodes = function (_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var headers, axios, cheerio, updatedUrl, res, data, $_1, episodeLinks_1, err_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    updatedUrl = url.replace('filmyfly.deals', 'filmyfly.observer');
                    return [4 /*yield*/, axios.get(updatedUrl, { headers: headers })];
                case 1:
                    res = _c.sent();
                    data = res.data;
                    ...
                    $_1(".dlbtn a, .dlink.dl").each(function (i, element) {
                        var _a, _b;
                        var title = (_b = (_a = $_1(element)
                ...
                case 2:
                    err_1 = _c.sent();
                    console.error("cl episode links", err_1);
                    return [2 /*return*/, []];
