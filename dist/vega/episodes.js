...
var getEpisodes = function (_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var axios, cheerio, headers, res, $_1, container, episodes_1, err_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    container = $_1(".entry-content,.entry-inner");
                    $_1(".unili-content,.code-block-1").remove();
                    episodes_1 = [];
                    container.find("h4").each(function (index, element) {
                        var el = $_1(element);
                        ...
                        var link = el
                            ...
                            .attr("href");
                        if (title && link) {
                            episodes_1.push({ title: title, link: link });
                        }
                    });
