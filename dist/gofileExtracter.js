    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    gofileRes = _a.sent();
                    return [4 /*yield*/, axios_1.default.post('https://api.gofile.io/accounts')];
                case 2:
                    genAccountres = _a.sent();
                    token = genAccountres.data.data.token;
                ...
                case 5:
                    e_1 = _a.sent();
                    console.log('gofile extracter err', e_1);
                    return [2 /*return*/, {
                            link: '',
                            token: '',
                        }];
