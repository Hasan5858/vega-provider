...
var getPosts = function (_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var getBaseUrl, axios, cheerio, baseURL, start, url;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getBaseUrl("tokyoinsider")];
                case 1:
                    baseURL = _c.sent();
                    start = page < 2 ? 0 : (page - 1) * 20;
                    url = "".concat(baseURL, "/").concat(filter, "&start=").concat(start);
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    baseURL = _c.sent();
                    start = page < 2 ? 0 : (page - 1) * 20;
                    url = "".concat(baseURL, "/anime/search?k=").concat(searchQuery, "&start=").concat(start);
                    return [2 /*return*/, posts({ baseURL: baseURL, url: url, signal: signal, axios: axios, cheerio: cheerio })];
            }
        });
    });
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    catalog_1 = [];
                    $_1('td.c_h2[width="40"]').map(function (i, element) {
                        var _a;
                        var image = (_a = $_1(element)
                            .find(".a_img")
                            .attr("src")) === null || _a === void 0 ? void 0 : _a.replace("small", "default");
                        var title = $_1(element).find("a").attr("title");
                        var link = baseURL + $_1(element).find("a").attr("href");
                        if (title && link && image) {
                            catalog_1.push({
                                title: title,
                                link: link,
