...
var getPosts = function (_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var getBaseUrl, cheerio, baseUrl, url;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getBaseUrl("multi")];
                case 1:
                    baseUrl = _c.sent();
                    url = "".concat(baseUrl + filter, "page/").concat(page, "/");
                    return [2 /*return*/, posts({ url: url, signal: signal, cheerio: cheerio })];
            }
        });
    });
};
...
function posts(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        var url = _b.url, signal = _b.signal, cheerio = _b.cheerio;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 3, , 4]);
                ...
                case 2:
                    ...
                    catalog_1 = [];
                    $_1(".items.full,.result-item")
                        .children()
                        .map(function (i, element) {
                        console.log("multiGetPosts element", element);
                        var title = $_1(element).find(".poster,.image").find("img").attr("alt");
                        var link = $_1(element).find(".poster,.image").find("a").attr("href");
                        var image = $_1(element).find(".poster,.image").find("img").attr("data-src") ||
                            $_1(element).find(".poster,.image").find("img").attr("src");
                        if (title && link && image) {
                            catalog_1.push({
                                title: title,
                                link: link,
                    ...
                    return [2 /*return*/, catalog_1.slice(0, 15)];
                case 3:
                    err_1 = _c.sent();
                    console.error("multiGetPosts error ", err_1);
                    return [2 /*return*/, []];
