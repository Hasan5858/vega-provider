...
var getMeta = function (_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var axios, cheerio, url, res, data, $_1, type, imdbId, title, image, synopsis, links_1, err_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    imdbId = "";
                    title = url.split("/")[4].replace(/-/g, " ");
                    image = $_1(".g-item").find("a").attr("href") || "";
                    synopsis = $_1(".wp-content").find("p").text() || "";
                    links_1 = [];
                    if (type === "series") {
                        $_1("#seasons")
                            .children()
                            ...
                            $_1(element)
                                ...
                                .map(function (i, element) {
                                var title = "Episode" +
                                    $_1(element).find(".numerando").text().trim().split("-")[1];
