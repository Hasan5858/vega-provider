    ...
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    baseUrl = _c.sent();
                    url = "".concat(baseUrl + filter, "/page/").concat(page, ".html");
    ...
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    baseUrl = _c.sent();
                    url = "".concat(baseUrl, "/page/").concat(page, ".html?s=").concat(searchQuery);
                    return [2 /*return*/, posts({ url: url, signal: signal, cheerio: cheerio })];
            }
        });
    });
            ...
            switch (_c.label) {
                ...
                case 2:
                    ...
                    $_1(".card-grid")
                        ...
                        var title = $_1(element).find(".movie-card-title").text();
                ...
                case 3:
                    err_1 = _c.sent();
                    console.error("4khdhubGetPosts error ", err_1);
                    return [2 /*return*/, []];
