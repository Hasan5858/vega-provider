        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getBaseUrl("hdhub")];
                case 1:
                    baseUrl = _c.sent();
                    url = "".concat(baseUrl + filter, "/page/").concat(page, "/");
                    return [2 /*return*/, posts({ url: url, signal: signal, providerContext: providerContext })];
            }
        });
    });
};
...
function posts(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var cheerio, res, data, $_1, catalog_1, err_1;
        var url = _b.url, signal = _b.signal, providerContext = _b.providerContext;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 3:
                    ...
                    $_1(".recent-movies")
                        ...
                        var title = $_1(element).find("figure").find("img").attr("alt");
                        var link = $_1(element).find("a").attr("href");
                        var image = $_1(element).find("figure").find("img").attr("src");
                        if (title && link && image) {
                            catalog_1.push({
                ...
                case 4:
                    err_1 = _c.sent();
                    console.error("hdhubGetPosts error ", err_1);
                    return [2 /*return*/, []];
